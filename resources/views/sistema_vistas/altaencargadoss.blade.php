                    ...
                    <div class="form-validation">
                        ...
                        <form class="form-valide" action="{{route('guardaenc')}}" method='POST' enctype='multipart/form-data'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" type='password' id="Contrasena" name='Contrasena' value="{{old('Contrasena')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" type='text' id="Nom_enc" name='Nom_enc' value="{{old('Nom_enc')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" type='text' id="Ap_penc" name='Ap_penc' value="{{old('Ap_penc')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" type='text' id="Ap_menc" name='Ap_menc' value="{{old('Ap_menc')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input class="form-control" type='text' id="RFC_enc" name='RFC_enc' value="{{old('RFC_enc')}}">
